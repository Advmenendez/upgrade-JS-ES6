...
let agessFiltered = agess.filter((age) => age >= 18);

console.log(agessFiltered)
...
let agesParFiltered = ages.filter((age) => age % 2 == 0);
...
let stremerssFiltered = streamerss.filter((streamer) => {
    if (streamer.name.includes("u")) {
        return streamer
    }
});
console.log(stremerssFiltered)

/* 5.5 utiliza .filter() para generar un nuevo array con los streamers que incluyan 
el caracter 'Legends' en su propiedad .gameMorePlayed. Recomendamos usar la funcion 
.includes() para la comprobación.
 */
let stremerssLegend = streamerss.filter((streamer) => {
